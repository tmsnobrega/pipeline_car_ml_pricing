...
class SingleCarSpider(scrapy.Spider):
  ...
  start_urls = [
      "https://www.autoscout24.com/offers/audi-a3-1-4-tfsi-ambit-pl-s-gasoline-grey-98a73cca-b400-43a0-ae77-8e2dae883ceb?sort=age&desc=1&lastSeenGuidPresent=true&cldtidx=1&position=1&search_id=pb1ebagkd6&source_otp=t10&ap_tier=t10&source=listpage_search-results&order_bucket=unknown&new_taxonomy_available=true&mia_tier=t10&boosting_product=none&relevance_adjustment=organic&applied_mia_tier=t10"
  ]
